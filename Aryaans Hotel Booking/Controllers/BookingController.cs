    ...
    public class BookingController : Controller
    {
        ...
        public async Task<IActionResult> Create(CreateBookingViewModel model)
        {
            ...
            if (room == null || room.Hotel == null)
            {
                ...
                model.HotelName = model.HotelName ?? "Unknown Hotel";
                model.RoomType = model.RoomType ?? "Unknown Room";
                return View(model);
            }
            ...
            else if (model.NumberOfGuests > room.Capacity)
            {
            ...
            try
            {
                ...
                var successViewModel = new BookingSuccessViewModel
                {
                    HotelName = room.Hotel.Name,
                    RoomType = room.RoomType,
                    GuestFullName = currentUser.UserName,
                    CheckInDate = model.CheckInDate,
                    CheckOutDate = model.CheckOutDate,
                    BookingReference = $"AHB-{booking.Id}"
                };
        ...
        {
            if (string.IsNullOrEmpty(model.HotelName) || string.IsNullOrEmpty(model.BookingReference))
            {
                return RedirectToAction("Index", "Home");
            }
        ...
        public async Task<IActionResult> MyBookings()
        {
            ...
            var bookings = await _context.Bookings
                ...
                .Select(b => new BookingViewModel
                {
                    ...
                    ImageUrl = b.Hotel.ImagePath,
                    StarRating = b.Hotel.StarRating,
                    LocationName = $"{b.Hotel.City}, {b.Hotel.Country}",
                    PricePerNight = b.Room.PricePerNight,
                    CurrencySymbol = "BGN",
                    NumberOfNights = (int)(b.CheckOutDate - b.CheckInDate).TotalDays,
                    TotalPrice = b.TotalPrice,
                    SelectedDates = $"{b.CheckInDate:MMM dd, yyyy} - {b.CheckOutDate:MMM dd, yyyy}",
                    SelectedGuests = $"{b.NumberOfGuests} Guest(s)"
                })
                .ToListAsync();
